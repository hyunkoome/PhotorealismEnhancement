...
class InferenceTask:
    ...
    def render_single_img_pred(self, min_resolution: int = 1080) -> None:
        ...
        output_gray_name = f"{in_fname_stem}_gray.jpg"
        output_demo_name = f"{in_fname_stem}_overlaid_classes.jpg"
        print('input_file dir: ', Path(self.input_file).parent)
        print('output_gray_name: ', output_gray_name)
        print('output_demo_name: ', output_demo_name)
        ...
        imageio.imwrite(os.path.join(Path(self.input_file).parent, output_demo_fpath), overlaid_img)
        imageio.imwrite(os.path.join(Path(self.input_file).parent, output_gray_fpath), pred_label_img)
